% initialize
sparisty = [54.68 48.55 46.83 44.66 44.36];
accuracy = [90.02 90.06 89.96 89.14 87.28];
...
legend(h([1 2 3 4 5]), '0.001','0.003','0.005','0.007','0.009', 'Location','southeast');

xlim([42 58]) 
ylim([86 91])

% Create xlabel
xlabel('Parameter Remaining (%)','FontSize',26);
set(gcf, 'Color', 'w');
...
print(fig,['ucihar-threhold-accuracy'],'-dpdf');